...
import {
    ...
    VALIDATION_ERROR,
    SERVICE_UNAVAILABLE, WRONG_METHOD_MESSAGE, WRONG_CONTENT_TYPE
...
export function WrongMethod (req,res) {
    return  res.status(WRONG_METHOD).json(WRONG_METHOD_MESSAGE)
}
export class WrongContentType extends Error {
    status = UNSUPPORTED_MEDIA_TYPE_CODE;
